  ...
  return (
    <section id="projects">
      <div className=" top-[66px]  h-auto relative maxContainer mx-auto  flex justify-evenly  flex-col items-center w-full">
        <h3 className="  mt-12 ml-5 uppercase max-mobileUS:tracking-[10px] max-mobileUS:text-xl tracking-[15px] max-mobileS:tracking-[10px] font-brunoAceSc  text-[#1BFD9C] text-2xl">
          Projects
        </h3>
        <div
