...
const ContactMe = () => {
  ...
  return (
    <div className="sectionMain flex relative flex-col text-center md:text-left md:flex-row max-w-7xl px-10 justify-evenly mx-auto items-center">
      ...
      <div className="flex flex-col space-y-10 ">
        ...
        <div className="space-y-10">
          <div className="flex item-center space-x-5 justify-center">
            ...
            <p className="text-2xl">+55 (031) 98265-4558</p>
          </div>
          <div className="flex item-center space-x-5 justify-center">
            <MapPinIcon className="text-[#F7AB0A] h-7 w-7 animate-pulse" />
            <p className="text-2xl">antoniomarcos.amrrds@gmail.com</p>
          </div>
          <div className="flex item-center space-x-5 justify-center">
            <EnvelopeIcon className="text-[#F7AB0A] h-7 w-7 animate-pulse" />
            <p className="text-2xl">Belo horizonte</p>
          </div>
        </div>
