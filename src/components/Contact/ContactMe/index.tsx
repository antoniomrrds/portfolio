...
const ContactMe = () => {
  return (
    <section id="contact">
      <div className="bg-[#121212] relative top-[66px]  h-auto ">
        <div className="grid md:grid-cols-2 grid-rows-1 w-full h-full">
          <picture className="relative">
            <h3 className="uppercase  tracking-[20px] absolute mx-auto right-0 left-0 top-1/2 text-orange text-2xl bg-no-repeat text-center">
              Contact
            </h3>
            <img
              className="object-fill w-full h-full object-center "
              src="/img/night-city.gif"
              alt="contact-me"
            />
          </picture>

          <div className="space-y-4  p-5 h-full flex flex-col justify-center items-center bg-black">
